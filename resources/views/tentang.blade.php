        ...
        <section class="py-5 bg-light">
            <div class="container px-5 my-5">
                <div class="text-center">
                    <h2 class="fw-bolder">Team Kami</h2>
                    <p class="lead fw-normal text-muted mb-5">Yang berdedikasi untuk Projek ini.</p>
                </div>
                <div class="row gx-5 row-cols-1 row-cols-sm-2 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5 mb-5 mb-xl-0">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle mb-4 px-4" src="https://dummyimage.com/150x150/ced4da/6c757d" alt="..." />
                            <h5 class="fw-bolder">Hidayatul Ummi</h5>
                            <div class="fst-italic text-muted">Team Leader</div>
                        </div>
                    </div>
                    <div class="col mb-5 mb-5 mb-xl-0">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle mb-4 px-4" src="https://dummyimage.com/150x150/ced4da/6c757d" alt="..." />
                            <h5 class="fw-bolder">Nurhafiza</h5>
                            <div class="fst-italic text-muted">Supervisor</div>
                        </div>
                    </div>
                    <div class="col mb-5 mb-5 mb-sm-0">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle mb-4 px-4" src="{{ asset('img/hf.png') }}" alt="..." />
                            <h5 class="fw-bolder">Hamed Fahdefi</h5>
                            <div class="fst-italic text-muted">Programming</div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="text-center">
                            <img class="img-fluid rounded-circle mb-4 px-4" src="https://dummyimage.com/150x150/ced4da/6c757d" alt="..." />
                            <h5 class="fw-bolder">Farhan Rauf Jufadli</h5>
                            <div class="fst-italic text-muted">Programming</div>
                        </div>
                    </div>
                </div>
