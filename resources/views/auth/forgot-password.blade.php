				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<form method="POST" class="needs-validation" novalidate="" autocomplete="off" action="{{ route('password.email') }}">
                @csrf
								<div class="mb-3">
						...
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								Ingat kata sandi Anda? <a href="{{ route('login') }}" class="text-dark">Masuk</a>
							</div>
						</div>
					</div>
