					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<form method="POST" class="needs-validation" novalidate="" autocomplete="off" action="{{ route('register') }}">
                                @csrf
								<div class="mb-3">
									<label class="mb-2 text-muted" for="name" :value="__('Name')">Nama</label>
								...
								<div class="mb-3">
									<label class="mb-2 text-muted" for="password" :value="__('Password')">Kata Sandi</label>
                                ...
                                <div class="mb-3">
									<label class="mb-2 text-muted" for="password" :value="__('Confirm Password')">Konfirmasi Kata Sandi</label>
						...
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								Sudah Memiliki Akun? <a href="{{ route('login') }}" class="text-dark">Masuk</a>
							</div>
						</div>
					</div>
